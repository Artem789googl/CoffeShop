...
import com.aleriateam.buildcoffee.databinding.ViewholderItemListBinding
...
RecyclerView.Adapter<ItemListCategoryAdapter.Viewholder>(){
    ...
    inner class Viewholder(val binding: ViewholderItemListBinding): RecyclerView.ViewHolder(binding.root)
